...
public class TeacherViewController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        teachers = List.of(new Teacher(1L, "Αλίκη", "Π."),
                new Teacher(2L, "Μπομπ", "Ντίλαν"),
                new Teacher(3L, "Κώστας", "Ανδ."),
                new Teacher(4L, "Δημήτρης", "Ανα."),
                new Teacher(5L, "Νίλ", "Τζ."),
                new Teacher(6L, "Άντ", "Μιν.")
        );
